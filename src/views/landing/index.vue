        ...
        <nav class="navbar navbar-expand-lg navbar-landing fixed-top" id="navbar">
            <b-container>
                <b-link class="navbar-brand" href="/">
                    <img src="@/assets/images/logo-thai-nguyen.svg" class="card-logo card-logo-dark" alt="logo dark"
                        height="17">
                    <img src="@/assets/images/logo-thai-nguyen.svg" class="card-logo card-logo-light" alt="logo light"
                        height="17">
                </b-link>
            ...
            <b-container>
                <b-row>
                    <b-col lg="4" class="mt-4">
                        <div>
                            <div>
                                <img src="@/assets/images/logo-thai-nguyen.svg" alt="logo light" height="17">
                            </div>
