...
const urlDetailTab = ref(
  `https://api-kcntest.gishub.vn/api/${props.slug}/quydatdautu/`
);
...
const address = reactive({
  ...
  details: [
    ...
    { name: "Dữ liệu thông tin khu công nghiệp", to: "ManageExchangeDataPage" },
  ],
});
  ...
  >
    <div class="d-flex justify-content-between flex-column">
      <div class="card mb-0" style="overflow-y: auto; overflow-x: hidden">
        <div class="card-body">
          <div>
            <h5>Dữ liệu thông tin khu công nghiệp</h5>
          </div>
          <div
            style="
              display: flex;
          ...
          <div class="tab-content">
            ...
            >
              Dịch vụ trả về danh sách các dữ liệu phản ánh khu cồng nghiệp dạng
              Json
            </div>
            <div
              ...
              style="padding;: 8px;margin-top:24px"
            >
              <h5 style="padding-bottom;: 8px">Thông tin dịch vụ</h5>
              <b-col>
                <b-col class="mb-3">
