...
const urlDetailTab = ref(
  `https://api-kcntest.gishub.vn/api/${props.slug}/feedback/`
);
...
const address = reactive({
  ...
  details: [
    ...
    { name: "Dữ liệu phản ánh hiện trường", to: "ManageExchangeDataPage" },
  ],
});
  ...
  >
    <div class="d-flex justify-content-between flex-column">
      <div class="card mb-0" style="overflow-y: auto; overflow-x: hidden">
        <div class="card-body">
          <div>
            <h5>Dữ liệu phản ánh hiện trường</h5>
          </div>
          <div
            style="
              display: flex;
          ...
          <div class="tab-content">
            ...
            >
              Dịch vụ trả về danh sách các dữ liệu phản ánh hiện trường dạng
              Json
            </div>
            <div
