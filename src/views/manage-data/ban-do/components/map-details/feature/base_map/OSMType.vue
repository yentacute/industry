...
const mapTypeMapBDHC = ref([
  ...
  setTypeMap4d(
    "Bản đồ Google Hybrid	",
    "google",
    require("@/assets/images/maptype/google.png")
  ),
]);
const handleSetMapType = () => {
  methods_map.setMapType(dataMapBDHC.mapType);
  emit("change-base-map", dataMapBDHC.mapType);
};
</script>

<template>
  <div class="mt-2 p-1">
    <span>Bản đồ nền OSM, Google</span>
    <div
